...
function Navbar() {
  ...
  return (
    <div>
      ...
      <nav className="bg-white border-gray-200 dark:bg-gray-900 border-b-4 border-b-blue-400 text-[20px]  ">
      ...
      <div className={`md:hidden border-l-4 p-4 border-l-blue-400 top-0 w-[25rem] h-full fixed z-40 bg-transparent  backdrop-blur-[20px] duration-300 ${sidebar ? "right-0" : "-right-[100%]"}`}>
        ...
        <ul className="h-[3rem]  font-medium flex flex-col rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
          <Link to="/">
