...
function Hero() {
  return (
    <div style={{ background: `url(https://raw.githubusercontent.com/PisethPanha/ebook_photos/refs/heads/main/378095555_a8514029-ca02-4f75-88ca-5affd797536f.jpg)`, height: "90vh", backgroundSize: "cover" }} className='flex justify-center items-center'>

      <div className='backdrop-blur-[20px] rounded-2xl border-4 border-blue-200 hover:scale-102 duration-200   p-4 text-center text-[30px]'>
