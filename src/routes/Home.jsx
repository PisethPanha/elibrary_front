...
function Home() {
  ...
  function handleBackToDefaultData() {
    setLoading1(true)
    axios.get("https://carefree-empathy-production.up.railway.app/getbook", { params: { offset: 0, limit: limit, language: '' } }).then((res) => { setImage(res.data); setLoading1(false) }
    )
    setBackBTN(false)
  }
  useEffect(() => {
    ...
    axios.get("https://carefree-empathy-production.up.railway.app/most-download").then((res) => { setDownload(res.data); setLoading3(false) }
    )
