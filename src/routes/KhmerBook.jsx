...
function KhmerBook() {
    ...
    function handleSearch(key) {
        ...
        axios.get("https://carefree-empathy-production.up.railway.app/admin_search", { params: { keyword: key, catagory: catagory, language: "khmer" } }).then((res) => { setResult(res.data); console.log(res.data); setLoadingResult(false) })
        if (key == "") {
    ...
    function handleBackToDefaultData() {
        setLoading(true)
        axios.get("https://carefree-empathy-production.up.railway.app/getbookastype", { params: { leng: "Khmer" } }).then((res) => { setImage(res.data); setLoading(false) })
        setBackBTN(false)
    }
    function handleApplySearch(key) {
        setLoading(true)
        axios.get("https://carefree-empathy-production.up.railway.app/keyword", { params: { keyword: key } }).then((res) => { setImage(res.data); setLoading(false) })
        setBackBTN(true)
        setResultVisibility(false)
