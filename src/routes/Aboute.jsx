    ...
    return (
        <div className='p-4'>
            <p className='text-[19px] text-justify'>
                ...
                Our platform supports multiple categories, including literature, science, history, technology, and more. Whether you are conducting research, preparing for exams, or expanding your knowledge, our E-Library is here to assist you every step of the way.

                Join our E-Library today and embark on a journey of knowledge and discovery!
            </p>
            <br /><br />
            ...
            <p className='text-[19px] text-center'>
                ...
                វេទិការបស់យើងគាំទ្រសៀវភៅជាច្រើនប្រភេទ រួមមានអក្សរសាស្រ្ត វិទ្យាសាស្រ្ត ប្រវត្តិសាស្រ្ត បច្ចេកវិទ្យា និងផ្សេងៗទៀត។ មិនថាអ្នកកំពុងស្រាវជ្រាវ រៀបចំសម្រាប់ការប្រឡង ឬបង្កើនចំណេះដឹងរបស់អ្នក ក៏បណ្ណាល័យអេឡិចត្រូនិករបស់យើងនៅទីនេះដើម្បីជួយអ្នកគ្រប់ជំហាន។
